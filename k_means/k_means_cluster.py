...
print(min([data_dict[key]["exercised_stock_options"] for key in data_dict if data_dict[key]["exercised_stock_options"]!='NaN']))
print(max([data_dict[key]["exercised_stock_options"] for key in data_dict if data_dict[key]["exercised_stock_options"]!='NaN']))
